        ...
        if strcmp(data.textdata(i,6),'NAND')
            if i == 1 || ~strcmp(data.textdata(i,4),data.textdata(i-1,4))
                ...
                if strcmp(data.textdata(i,2),'1')
                    rNandMinDistUser1 = [rNandMinDistUser1 data.data(i,8)];
                elseif strcmp(data.textdata(i,2),'2')
                    rNandMinDistUser2 = [rNandMinDistUser2 data.data(i,8)];
                elseif strcmp(data.textdata(i,2),'3')
                    rNandMinDistUser3 = [rNandMinDistUser3 data.data(i,8)];
                elseif strcmp(data.textdata(i,2),'4')
                    rNandMinDistUser4 = [rNandMinDistUser4 data.data(i,8)];
                elseif strcmp(data.textdata(i,2),'5')
                    rNandMinDistUser5 = [rNandMinDistUser5 data.data(i,8)];
                elseif strcmp(data.textdata(i,2),'6')
                    rNandMinDistUser6 = [rNandMinDistUser6 data.data(i,8)];
                elseif strcmp(data.textdata(i,2),'7')
                    rNandMinDistUser7 = [rNandMinDistUser7 data.data(i,8)];
                elseif strcmp(data.textdata(i,2),'8')
                    rNandMinDistUser8 = [rNandMinDistUser8 data.data(i,8)];
                elseif strcmp(data.textdata(i,2),'9')
                    rNandMinDistUser9 = [rNandMinDistUser9 data.data(i,8)];
                elseif strcmp(data.textdata(i,2),'10')
                    rNandMinDistUser10 = [rNandMinDistUser10 data.data(i,8)];
                elseif strcmp(data.textdata(i,2),'11')
                    rNandMinDistUser11 = [rNandMinDistUser11 data.data(i,8)];
                elseif strcmp(data.textdata(i,2),'12')
                    rNandMinDistUser12 = [rNandMinDistUser12 data.data(i,8)];
    ...
    elseif strcmp(data.textdata(i,3),'EQ1')||strcmp(data.textdata(i,3),'EQ2')
        switch char(data.textdata(i,6))
            case 'NAND'
                if i == 1 || ~strcmp(data.textdata(i,4),data.textdata(i-1,4))
                    if strcmp(data.textdata(i,2),'1')
                        eNandMinDist1 = [eNandMinDist1 data.data(i,8)];
                    elseif strcmp(data.textdata(i,2),'2')
                        eNandMinDist2 = [eNandMinDist2 data.data(i,8)];
                    elseif strcmp(data.textdata(i,2),'3')
                        eNandMinDist3 = [eNandMinDist3 data.data(i,8)];
                    elseif strcmp(data.textdata(i,2),'4')
                        eNandMinDist4 = [eNandMinDist4 data.data(i,8)];
                    elseif strcmp(data.textdata(i,2),'5')
                        eNandMinDist5 = [eNandMinDist5 data.data(i,8)];
                    elseif strcmp(data.textdata(i,2),'6')
                        eNandMinDist6 = [eNandMinDist6 data.data(i,8)];
                    elseif strcmp(data.textdata(i,2),'7')
                        eNandMinDist7 = [eNandMinDist7 data.data(i,8)];
                    elseif strcmp(data.textdata(i,2),'8')
                        eNandMinDist8 = [eNandMinDist8 data.data(i,8)];
                    elseif strcmp(data.textdata(i,2),'9')
                        eNandMinDist9 = [eNandMinDist9 data.data(i,8)];
                    elseif strcmp(data.textdata(i,2),'10')
                        eNandMinDist10 = [eNandMinDist10 data.data(i,8)];
                    elseif strcmp(data.textdata(i,2),'11')
                        eNandMinDist11 = [eNandMinDist11 data.data(i,8)];
                    elseif strcmp(data.textdata(i,2),'12')
                        eNandMinDist12 = [eNandMinDist12 data.data(i,8)];
                    end
                end
