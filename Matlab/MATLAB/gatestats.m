...
%for n=1:length(files)
    ...
    %rConsecutiveShapes
    %rTotalShapes
    percentageOfConsecutive = [100*(rConsecutiveShapes/rTotalShapes) 100*(eConsecutiveShapes/eTotalShapes) 100*(cConsecutiveShapes/cTotalShapes)];
    ...
    totNotData =[avgNotPressure; avgNotWidth; avgNotHeight; avgNotCurvature; avgNotNumPoints; avgNotMinDist];
    
    figure
    subplot(1,6,1)
    bar(totWireData(1,:))
    xlabel('Avg Pressure / Stroke')
    set(gca,'XTickLabel',{'R', 'E', 'C'})
    subplot(1,6,2)
    bar(totWireData(2,:))
