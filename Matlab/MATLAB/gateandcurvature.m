function avgAndMinDistUserAlldiff= gateandcurvature(file)
...
for i=1:length(data.textdata)
        ...
        if strcmp(data.textdata(i,6),'AND')
            if i == 1 || ~strcmp(data.textdata(i,4),data.textdata(i-1,4))
                ...
                if strcmp(data.textdata(i,2),'1')
                    rAndMinDistUser1 = [rAndMinDistUser1 data.data(i,4)];
                elseif strcmp(data.textdata(i,2),'2')
                    rAndMinDistUser2 = [rAndMinDistUser2 data.data(i,4)];
                elseif strcmp(data.textdata(i,2),'3')
                    rAndMinDistUser3 = [rAndMinDistUser3 data.data(i,4)];
                elseif strcmp(data.textdata(i,2),'4')
                    rAndMinDistUser4 = [rAndMinDistUser4 data.data(i,4)];
                elseif strcmp(data.textdata(i,2),'5')
                    rAndMinDistUser5 = [rAndMinDistUser5 data.data(i,4)];
                elseif strcmp(data.textdata(i,2),'6')
                    rAndMinDistUser6 = [rAndMinDistUser6 data.data(i,4)];
                elseif strcmp(data.textdata(i,2),'7')
                    rAndMinDistUser7 = [rAndMinDistUser7 data.data(i,4)];
                elseif strcmp(data.textdata(i,2),'8')
                    rAndMinDistUser8 = [rAndMinDistUser8 data.data(i,4)];
                elseif strcmp(data.textdata(i,2),'9')
                    rAndMinDistUser9 = [rAndMinDistUser9 data.data(i,4)];
                elseif strcmp(data.textdata(i,2),'10')
                    rAndMinDistUser10 = [rAndMinDistUser10 data.data(i,4)];
                elseif strcmp(data.textdata(i,2),'11')
                    rAndMinDistUser11 = [rAndMinDistUser11 data.data(i,4)];
                elseif strcmp(data.textdata(i,2),'12')
                    rAndMinDistUser12 = [rAndMinDistUser12 data.data(i,4)];
    ...
    elseif strcmp(data.textdata(i,3),'EQ1')||strcmp(data.textdata(i,3),'EQ2')
        switch char(data.textdata(i,6))
            case 'AND'
                if i == 1 || ~strcmp(data.textdata(i,4),data.textdata(i-1,4))
                    if strcmp(data.textdata(i,2),'1')
                        eAndMinDist1 = [eAndMinDist1 data.data(i,4)];
                    elseif strcmp(data.textdata(i,2),'2')
                        eAndMinDist2 = [eAndMinDist2 data.data(i,4)];
                    elseif strcmp(data.textdata(i,2),'3')
                        eAndMinDist3 = [eAndMinDist3 data.data(i,4)];
                    elseif strcmp(data.textdata(i,2),'4')
                        eAndMinDist4 = [eAndMinDist4 data.data(i,4)];
                    elseif strcmp(data.textdata(i,2),'5')
                        eAndMinDist5 = [eAndMinDist5 data.data(i,4)];
                    elseif strcmp(data.textdata(i,2),'6')
                        eAndMinDist6 = [eAndMinDist6 data.data(i,4)];
                    elseif strcmp(data.textdata(i,2),'7')
                        eAndMinDist7 = [eAndMinDist7 data.data(i,4)];
                    elseif strcmp(data.textdata(i,2),'8')
                        eAndMinDist8 = [eAndMinDist8 data.data(i,4)];
                    elseif strcmp(data.textdata(i,2),'9')
                        eAndMinDist9 = [eAndMinDist9 data.data(i,4)];
                    elseif strcmp(data.textdata(i,2),'10')
                        eAndMinDist10 = [eAndMinDist10 data.data(i,4)];
                    elseif strcmp(data.textdata(i,2),'11')
                        eAndMinDist11 = [eAndMinDist11 data.data(i,4)];
                    elseif strcmp(data.textdata(i,2),'12')
                        eAndMinDist12 = [eAndMinDist12 data.data(i,4)];
                    end
                end
    ...
    avgAndMinDistUserAll = [avgAndMinDistUser1; avgAndMinDistUser2; avgAndMinDistUser3; avgAndMinDistUser4; avgAndMinDistUser5; avgAndMinDistUser6; avgAndMinDistUser7; avgAndMinDistUser8; avgAndMinDistUser9; avgAndMinDistUser10;avgAndMinDistUser11; avgAndMinDistUser12;];
    avgAndMinDistUserAlldiff = [diff(avgAndMinDistUser1); diff(avgAndMinDistUser2); diff(avgAndMinDistUser3); diff(avgAndMinDistUser4); diff(avgAndMinDistUser5); diff(avgAndMinDistUser6); diff(avgAndMinDistUser7); diff(avgAndMinDistUser8); diff(avgAndMinDistUser9); diff(avgAndMinDistUser10); diff(avgAndMinDistUser11); diff(avgAndMinDistUser12);];
