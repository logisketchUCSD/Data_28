function avgXorMinDistUserAlldiff = gatexortime(file)
        ...
        if strcmp(data.textdata(i,6),'XOR')
            if i == 1 || ~strcmp(data.textdata(i,4),data.textdata(i-1,4))
                ...
                if strcmp(data.textdata(i,2),'1')
                    rXorMinDistUser1 = [rXorMinDistUser1 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'2')
                    rXorMinDistUser2 = [rXorMinDistUser2 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'3')
                    rXorMinDistUser3 = [rXorMinDistUser3 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'4')
                    rXorMinDistUser4 = [rXorMinDistUser4 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'5')
                    rXorMinDistUser5 = [rXorMinDistUser5 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'6')
                    rXorMinDistUser6 = [rXorMinDistUser6 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'7')
                    rXorMinDistUser7 = [rXorMinDistUser7 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'8')
                    rXorMinDistUser8 = [rXorMinDistUser8 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'9')
                    rXorMinDistUser9 = [rXorMinDistUser9 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'10')
                    rXorMinDistUser10 = [rXorMinDistUser10 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'11')
                    rXorMinDistUser11 = [rXorMinDistUser11 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'12')
                    rXorMinDistUser12 = [rXorMinDistUser12 data.data(i,12)];
    ...
    elseif strcmp(data.textdata(i,3),'EQ1')||strcmp(data.textdata(i,3),'EQ2')
        switch char(data.textdata(i,6))
            case 'XOR'
                if i == 1 || ~strcmp(data.textdata(i,4),data.textdata(i-1,4))
                    if strcmp(data.textdata(i,2),'1')
                        eXorMinDist1 = [eXorMinDist1 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'2')
                        eXorMinDist2 = [eXorMinDist2 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'3')
                        eXorMinDist3 = [eXorMinDist3 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'4')
                        eXorMinDist4 = [eXorMinDist4 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'5')
                        eXorMinDist5 = [eXorMinDist5 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'6')
                        eXorMinDist6 = [eXorMinDist6 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'7')
                        eXorMinDist7 = [eXorMinDist7 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'8')
                        eXorMinDist8 = [eXorMinDist8 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'9')
                        eXorMinDist9 = [eXorMinDist9 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'10')
                        eXorMinDist10 = [eXorMinDist10 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'11')
                        eXorMinDist11 = [eXorMinDist11 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'12')
                        eXorMinDist12 = [eXorMinDist12 data.data(i,12)];
                    end
                end
