function avgNotMinDistUserAlldiff = gatenottime(file)
        ...
        if strcmp(data.textdata(i,6),'NOT')
            if i == 1 || ~strcmp(data.textdata(i,4),data.textdata(i-1,4))
                ...
                if strcmp(data.textdata(i,2),'1')
                    rNotMinDistUser1 = [rNotMinDistUser1 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'2')
                    rNotMinDistUser2 = [rNotMinDistUser2 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'3')
                    rNotMinDistUser3 = [rNotMinDistUser3 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'4')
                    rNotMinDistUser4 = [rNotMinDistUser4 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'5')
                    rNotMinDistUser5 = [rNotMinDistUser5 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'6')
                    rNotMinDistUser6 = [rNotMinDistUser6 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'7')
                    rNotMinDistUser7 = [rNotMinDistUser7 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'8')
                    rNotMinDistUser8 = [rNotMinDistUser8 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'9')
                    rNotMinDistUser9 = [rNotMinDistUser9 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'10')
                    rNotMinDistUser10 = [rNotMinDistUser10 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'11')
                    rNotMinDistUser11 = [rNotMinDistUser11 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'12')
                    rNotMinDistUser12 = [rNotMinDistUser12 data.data(i,12)];
    ...
    elseif strcmp(data.textdata(i,3),'EQ1')||strcmp(data.textdata(i,3),'EQ2')
        switch char(data.textdata(i,6))
            case 'NOT'
                if i == 1 || ~strcmp(data.textdata(i,4),data.textdata(i-1,4))
                    if strcmp(data.textdata(i,2),'1')
                        eNotMinDist1 = [eNotMinDist1 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'2')
                        eNotMinDist2 = [eNotMinDist2 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'3')
                        eNotMinDist3 = [eNotMinDist3 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'4')
                        eNotMinDist4 = [eNotMinDist4 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'5')
                        eNotMinDist5 = [eNotMinDist5 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'6')
                        eNotMinDist6 = [eNotMinDist6 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'7')
                        eNotMinDist7 = [eNotMinDist7 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'8')
                        eNotMinDist8 = [eNotMinDist8 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'9')
                        eNotMinDist9 = [eNotMinDist9 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'10')
                        eNotMinDist10 = [eNotMinDist10 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'11')
                        eNotMinDist11 = [eNotMinDist11 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'12')
                        eNotMinDist12 = [eNotMinDist12 data.data(i,12)];
                    end
                end
