function avgNorMinDistUserAlldiff = gatenortime(file)
        ...
        if strcmp(data.textdata(i,6),'NOR')
            if i == 1 || ~strcmp(data.textdata(i,4),data.textdata(i-1,4))
                ...
                if strcmp(data.textdata(i,2),'1')
                    rNorMinDistUser1 = [rNorMinDistUser1 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'2')
                    rNorMinDistUser2 = [rNorMinDistUser2 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'3')
                    rNorMinDistUser3 = [rNorMinDistUser3 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'4')
                    rNorMinDistUser4 = [rNorMinDistUser4 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'5')
                    rNorMinDistUser5 = [rNorMinDistUser5 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'6')
                    rNorMinDistUser6 = [rNorMinDistUser6 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'7')
                    rNorMinDistUser7 = [rNorMinDistUser7 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'8')
                    rNorMinDistUser8 = [rNorMinDistUser8 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'9')
                    rNorMinDistUser9 = [rNorMinDistUser9 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'10')
                    rNorMinDistUser10 = [rNorMinDistUser10 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'11')
                    rNorMinDistUser11 = [rNorMinDistUser11 data.data(i,12)];
                elseif strcmp(data.textdata(i,2),'12')
                    rNorMinDistUser12 = [rNorMinDistUser12 data.data(i,12)];
    ...
    elseif strcmp(data.textdata(i,3),'EQ1')||strcmp(data.textdata(i,3),'EQ2')
        switch char(data.textdata(i,6))
            case 'NOR'
                if i == 1 || ~strcmp(data.textdata(i,4),data.textdata(i-1,4))
                    if strcmp(data.textdata(i,2),'1')
                        eNorMinDist1 = [eNorMinDist1 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'2')
                        eNorMinDist2 = [eNorMinDist2 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'3')
                        eNorMinDist3 = [eNorMinDist3 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'4')
                        eNorMinDist4 = [eNorMinDist4 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'5')
                        eNorMinDist5 = [eNorMinDist5 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'6')
                        eNorMinDist6 = [eNorMinDist6 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'7')
                        eNorMinDist7 = [eNorMinDist7 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'8')
                        eNorMinDist8 = [eNorMinDist8 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'9')
                        eNorMinDist9 = [eNorMinDist9 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'10')
                        eNorMinDist10 = [eNorMinDist10 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'11')
                        eNorMinDist11 = [eNorMinDist11 data.data(i,12)];
                    elseif strcmp(data.textdata(i,2),'12')
                        eNorMinDist12 = [eNorMinDist12 data.data(i,12)];
                    end
                end
