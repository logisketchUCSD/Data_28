        ...
        if strcmp(data.textdata(i,6),'OR')
            if i == 1 || ~strcmp(data.textdata(i,4),data.textdata(i-1,4))
                ...
                if strcmp(data.textdata(i,2),'1')
                    rOrMinDistUser1 = [rOrMinDistUser1 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'2')
                    rOrMinDistUser2 = [rOrMinDistUser2 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'3')
                    rOrMinDistUser3 = [rOrMinDistUser3 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'4')
                    rOrMinDistUser4 = [rOrMinDistUser4 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'5')
                    rOrMinDistUser5 = [rOrMinDistUser5 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'6')
                    rOrMinDistUser6 = [rOrMinDistUser6 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'7')
                    rOrMinDistUser7 = [rOrMinDistUser7 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'8')
                    rOrMinDistUser8 = [rOrMinDistUser8 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'9')
                    rOrMinDistUser9 = [rOrMinDistUser9 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'10')
                    rOrMinDistUser10 = [rOrMinDistUser10 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'11')
                    rOrMinDistUser11 = [rOrMinDistUser11 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'12')
                    rOrMinDistUser12 = [rOrMinDistUser12 data.data(i,9)];
    ...
    elseif strcmp(data.textdata(i,3),'EQ1')||strcmp(data.textdata(i,3),'EQ2')
        switch char(data.textdata(i,6))
            case 'OR'
                if i == 1 || ~strcmp(data.textdata(i,4),data.textdata(i-1,4))
                    if strcmp(data.textdata(i,2),'1')
                        eOrMinDist1 = [eOrMinDist1 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'2')
                        eOrMinDist2 = [eOrMinDist2 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'3')
                        eOrMinDist3 = [eOrMinDist3 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'4')
                        eOrMinDist4 = [eOrMinDist4 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'5')
                        eOrMinDist5 = [eOrMinDist5 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'6')
                        eOrMinDist6 = [eOrMinDist6 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'7')
                        eOrMinDist7 = [eOrMinDist7 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'8')
                        eOrMinDist8 = [eOrMinDist8 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'9')
                        eOrMinDist9 = [eOrMinDist9 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'10')
                        eOrMinDist10 = [eOrMinDist10 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'11')
                        eOrMinDist11 = [eOrMinDist11 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'12')
                        eOrMinDist12 = [eOrMinDist12 data.data(i,9)];
                    end
                end
