function avgWireMinDistUserAllDiff = gatewire(file)
        ...
        if strcmp(data.textdata(i,6),'Wire')
            if i == 1 || ~strcmp(data.textdata(i,4),data.textdata(i-1,4))
                ...
                if strcmp(data.textdata(i,2),'1')
                    rWireMinDistUser1 = [rWireMinDistUser1 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'2')
                    rWireMinDistUser2 = [rWireMinDistUser2 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'3')
                    rWireMinDistUser3 = [rWireMinDistUser3 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'4')
                    rWireMinDistUser4 = [rWireMinDistUser4 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'5')
                    rWireMinDistUser5 = [rWireMinDistUser5 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'6')
                    rWireMinDistUser6 = [rWireMinDistUser6 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'7')
                    rWireMinDistUser7 = [rWireMinDistUser7 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'8')
                    rWireMinDistUser8 = [rWireMinDistUser8 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'9')
                    rWireMinDistUser9 = [rWireMinDistUser9 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'10')
                    rWireMinDistUser10 = [rWireMinDistUser10 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'11')
                    rWireMinDistUser11 = [rWireMinDistUser11 data.data(i,9)];
                elseif strcmp(data.textdata(i,2),'12')
                    rWireMinDistUser12 = [rWireMinDistUser12 data.data(i,9)];
    ...
    elseif strcmp(data.textdata(i,3),'EQ1')||strcmp(data.textdata(i,3),'EQ2')
        switch char(data.textdata(i,6))
            case 'Wire'
                if i == 1 || ~strcmp(data.textdata(i,4),data.textdata(i-1,4))
                    if strcmp(data.textdata(i,2),'1')
                        eWireMinDist1 = [eWireMinDist1 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'2')
                        eWireMinDist2 = [eWireMinDist2 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'3')
                        eWireMinDist3 = [eWireMinDist3 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'4')
                        eWireMinDist4 = [eWireMinDist4 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'5')
                        eWireMinDist5 = [eWireMinDist5 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'6')
                        eWireMinDist6 = [eWireMinDist6 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'7')
                        eWireMinDist7 = [eWireMinDist7 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'8')
                        eWireMinDist8 = [eWireMinDist8 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'9')
                        eWireMinDist9 = [eWireMinDist9 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'10')
                        eWireMinDist10 = [eWireMinDist10 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'11')
                        eWireMinDist11 = [eWireMinDist11 data.data(i,9)];
                    elseif strcmp(data.textdata(i,2),'12')
                        eWireMinDist12 = [eWireMinDist12 data.data(i,9)];
                    end
                end
